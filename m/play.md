...
<div data-with-frame="true"><figure><img src="../.gitbook/assets/нюх.png" alt=""><figcaption></figcaption></figure></div>
...
{% hint style="info" %}
Если вы не хотите заполнять заявку или она была отклонена, вы можете приобрести проходку, дополнительно поддержав проект. Временно недоступно.
{% endhint %}
